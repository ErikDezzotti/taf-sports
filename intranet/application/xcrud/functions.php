...
function gera_url($postdata, $xcrud){
    $modurl=tira_acento( $postdata->get('titulo'));
    $postdata->set('url',  $modurl);
}
function gera_urlAtleta($postdata, $xcrud){
    $modurl=tira_acento( $postdata->get('apelido'));
    $postdata->set('url',  $modurl);
}
function gera_urlTecnico($postdata, $xcrud){
    $modurl=tira_acento( $postdata->get('nome'));
    $postdata->set('url',  $modurl);
}
function gera_urlCase($postdata, $xcrud){
    $modurl=tira_acento( $postdata->get('nome'));
    $postdata->set('url',  $modurl);
}
function gera_urlProfissional($postdata, $xcrud){
    $modurl=tira_acento( $postdata->get('nome'));
    $postdata->set('url',  $modurl);
}