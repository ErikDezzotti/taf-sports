...
{
    // default connection
    public static $dbname = 'sitetaf'; // Your database name
    public static $dbuser = 'sitetaf'; // Your database username
    public static $dbpass = 'igorFut@13'; // // Your database password
    public static $dbhost = 'sitetaf.mysql.dbaas.com.br'; // Your database host, 'localhost' is default.
