  ...
  <div class="taf-footer__container">
      ...
      <div class="taf-footer__social" aria-label="Redes sociais">
        ...
        <div class="taf-footer__social-list">
          <a href="https://www.instagram.com/tafsportsbr/" target="_blank" rel="noopener noreferrer"
            class="taf-footer__social-link" aria-label="Siga-nos no Instagram">
          ...
          <a href="https://www.facebook.com/tafsportsbr/" target="_blank" rel="noopener noreferrer"
            class="taf-footer__social-link" aria-label="Siga-nos no Facebook">
    ...
    <div class="taf-footer__bottom">
      ...
      <div class="taf-footer__copyright">
        ...
        <p class="taf-footer__copyright-line">
          Desenvolvido pela <a href="http://brandpage.com.br/" target="_blank" rel="noopener noreferrer"
            class="taf-footer__brand-link">Brandpage</a> para atletas de elite
        </p>
      </div>
    </div>
...
<script type='text/javascript'>
  var myPlayer;
  jQuery(function () {
    // ✅ CORREÇÃO SENIOR: Removido código comercial pupunzi
...
<?php
// ✅ CORREÇÃO SENIOR: Verificar isset para $tipo
if (isset($tipo) && $tipo == "Feminino"):
  ?>
