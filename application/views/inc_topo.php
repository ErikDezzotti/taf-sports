...
<body>
      ...
      <nav class="taf-nav" role="navigation" aria-label="Navegação Principal">
        <ul class="taf-nav__list">
          <li class="taf-nav__item">
            <a href="<?=base_url();?>"
               class="taf-nav__link <?php if($pagina == "home") { echo 'active'; } ?>"
               aria-current="<?php if($pagina == "home") { echo 'page'; } ?>">
              Home
            </a>
          </li>
          <li class="taf-nav__item">
          ...
          <li class="taf-nav__item">
            <a href="<?=base_url();?>servicos"
               class="taf-nav__link <?php if($pagina == "servicos") { echo 'active'; } ?>"
               aria-current="<?php if($pagina == "servicos") { echo 'page'; } ?>">
              Serviços
            </a>
          </li>
          <li class="taf-nav__item">
          ...
          <li class="taf-nav__item">
            <a href="<?=base_url();?>contato"
               class="taf-nav__link <?php if($pagina == "contato") { echo 'active'; } ?>"
               aria-current="<?php if($pagina == "contato") { echo 'page'; } ?>">
              Contato
            </a>
          </li>
          <li class="taf-nav__item">
  ...
  <div class="taf-mobile-menu" id="tafMobileMenu" role="dialog" aria-modal="true" aria-label="Menu de Navegação">
    ...
    <button class="taf-mobile-close" id="tafMobileClose" aria-label="Fechar menu">
      <svg class="taf-mobile-close__icon" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <nav class="taf-mobile-nav" role="navigation" aria-label="Navegação Mobile">
      <ul class="taf-mobile-nav__list">
        <li class="taf-mobile-nav__item">
          <a href="<?=base_url();?>"
             class="taf-mobile-nav__link <?php if($pagina == "home") { echo 'active'; } ?>"
             aria-current="<?php if($pagina == "home") { echo 'page'; } ?>">
            Home
        ...
        <li class="taf-mobile-nav__item">
          <a href="<?=base_url();?>servicos"
             class="taf-mobile-nav__link <?php if($pagina == "servicos") { echo 'active'; } ?>"
             aria-current="<?php if($pagina == "servicos") { echo 'page'; } ?>">
            Serviços
            <span class="taf-mobile-nav__arrow" aria-hidden="true">→</span>
          </a>
        ...
        <li class="taf-mobile-nav__item">
          <a href="<?=base_url();?>contato"
             class="taf-mobile-nav__link <?php if($pagina == "contato") { echo 'active'; } ?>"
             aria-current="<?php if($pagina == "contato") { echo 'page'; } ?>">
            Contato
            <span class="taf-mobile-nav__arrow" aria-hidden="true">→</span>
          </a>
